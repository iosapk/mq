	...
	$.addInit({
		...
		handle: function() {
			...
			if($.os.plus) {
				...
				//					a.href = '../../ask.dcloud.net.cn/article/113';
				//					err.appendChild(a);
...
(function($, document) {
    ...
    $.plusReady(function() {
                ...
                $.plusReady(function() {
                    if (self.options.down.style == "circle") {
                        ...
                        webview.addEventListener('close', function() {
                            var attrWebviewId = self.options.webviewId && self.options.webviewId.replace(/\//g, "_"); //替换所有"../default.htm" 
        ...
        $.fn.pullRefresh_native = function(options) {
            ...
            var pullRefreshApi = null;
            var attrWebviewId = options.webviewId && options.webviewId.replace(/\//g, "_"); //替换所有"../default.htm"
